...
public class ModeloVenta {
    ...
    public ModeloVenta(String tituloPieza, String emailDuenoAnterior, String emaulNuevoDueno, Double precio,
            LocalDate fecha, ModeloTiposPago tipoPago, ModeloTipoDeVenta tipoDeVenta, Boolean confirmadoAdmin) {
        this.asignarIdUnico();
        this.tituloPieza = tituloPieza;
        this.emailDuenoAnterior = emailDuenoAnterior;
        this.emailNuevoDueno = emaulNuevoDueno;
        this.precio = precio;
        this.fecha = fecha;
        this.tipoPago = tipoPago;
        this.tipoVenta = tipoDeVenta;
    ...
    public void setEmailNuevoDueno(String emaulNuevoDueno) {
        this.emailNuevoDueno = emaulNuevoDueno;
    }
